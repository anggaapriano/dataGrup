...
public class HistoryPesawat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_pesawat);
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking tiket pesawat untuk rute perjalanan " + tujuan + " dengan menggunakan pelayanan maskapai " + asal + " pada tanggal " + tanggal + ". " +
        ...
        listBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(HistoryPesawat.this);
