...
public class HistoryKereta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_kereta);

        dbHelper = new DBBookKereta(this);
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking tiket kereta untuk rute perjalanan " + tujuan + " dengan menggunakan pelayanan maskapai " + asal + " pada tanggal " + tanggal + ". " +
        ...
        listBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(HistoryKereta.this);
